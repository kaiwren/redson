...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Redson is a browsers based MVC component framework written in Ruby using the Opal ruby-to-js compiler.}
  spec.description   = %q{Redson is a browsers based MVC component framework written in Ruby using the Opal ruby-to-js compiler.}
